...
class CommentBottomIcons extends StatefulWidget {
  final String commentId, postId;
  final List<String> relates;

  const CommentBottomIcons(
      {super.key,
  ...
  @override
  State<CommentBottomIcons> createState() => _CommentBottomIconsState();
}

/// Post Bottom icons that enable users to relate to a post and also see number of comments in a post
class _CommentBottomIconsState extends State<CommentBottomIcons>
