      ...
      body: Container(
        child: FutureBuilder<QuerySnapshot>(
          future: FirebaseFirestore.instance
              ...
              .where('typeOfField',
                  isEqualTo:
                      'General') // Replace 'Addiction' with the desired typeOfField value
              .get(),
          builder: (context, snapshot) {
            ...
            // Process the retrieved planDocuments as needed

            return ListView.builder(
              itemCount: planDocuments.length,
              itemBuilder: (context, index) {
                DocumentSnapshot planSnapshot = planDocuments[index];
                Map<String, dynamic> planData = planSnapshot.data() as Map<
                    String,
                    dynamic>; // Explicitly cast planData to Map<String, dynamic>
